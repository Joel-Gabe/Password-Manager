...
class MyMainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.conn = sqlite3.connect(os.path.join(self.base_directory, 'accounts.db'))    
    ...
    def createKeys(self):
        ...
        with open(os.path.join(self.base_directory, "private_key.pem"), 'wb') as privateKeyFile:
    ...
    def setupUi(self):
        ...
        self.setWindowIcon(QtGui.QIcon(os.path.join(self.base_directory, '232962.png')))
        self.retranslateUi()
...
class Ui_Drag_and_Drop_Dialog(QtWidgets.QDialog):
    ...
    def openFileDialog(self):
        ...
        filepath = QtWidgets.QFileDialog.getOpenFileName(
            ...
            directory = MainWindow.base_directory,
            filter = file_filter
